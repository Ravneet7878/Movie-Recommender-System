...
movies = pickle.load(open("movies.pkl", "rb"))  # movies should be a DataFrame containing 'title' and 'movie_id'
...
selected_movie = st.selectbox(
    ...
    movies['title'].values  # Make sure 'movies' is a DataFrame with a 'title' column
)
